...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $(".view_doctet").click(function(){
       var page=btoa("submition");
      var doc_data=btoa($(this).attr("id"));
      //alert(doc_data)
      if(doc_data){
          //$("#pdf_shows").attr("src")="doc_data";
            $.post("Huduma_WhiteBox/innovator/innovation/property.php",{page:page,doc_data:doc_data,innovation:innovation},function(data){
       $("#dock_display").html(data).show();
       $("#summary").hide();
})
      }else{
  ...
  var innovation=btoa('<?php echo $innovation?>');
    $(".view_doct").click(function(){
      ...
      if(doc_data){
          //$("#pdf_shows").attr("src")="doc_data";
            $.post("Huduma_WhiteBox/innovator/innovation/documents.php",{page:page,doc_data:doc_data,innovation:innovation},function(data){
       $("#dock_display").html(data).show();
        $("#summary").hide();
})
      }else{
