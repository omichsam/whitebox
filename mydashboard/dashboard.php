...
<section class="content-header dashboard_holder my-3">
    <div class="d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center">
            <h3 id="dashpdrt" class="mb-0 mr-3"><?php echo $error_message ?></h3>
            <span class="hidden-xs header_info" id="dashboard_loaders"></span>
        </div>
        
        <div class="d-flex align-items-center">
            <!-- E-learning buttons (commented out) -->
            <!-- 
            <a class="btn desktop_hidden btn-primary elearningleader <?php echo $get_elerning ?> mr-2" id="elearning_log" style="color: #fff;cursor: pointer;">E-learning</a>
            <a class="btn desktop_hidden btn-success elearningrequest btn btn-primary mr-2" id="elearning_lognew" style="color: #fff;cursor: pointer;display:none">E-learning</a>
            -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 no_padding col-xs-4" style="text-align:right;">
                                <i class="livicon pull-right" data-name="user" data-l="true" data-c="#fff"
                                    data-hc="#fff" data-s="80" id="livicon-11" style="width: 80px; height: 80px;"></i>
                            </div>
                        ...
                        <div class="row no_padding">
                            ...
                            <div class="col-md-4 no_padding col-xs-4" style="text-align:right;">
                                <i class="livicon pull-right" data-name="wrench" data-l="true" data-c="#fff"
                                    data-hc="#fff" data-s="80" id="livicon-12" style="width: 80px; height: 80px;"></i>
                            </div>
                ...
                <div class="panel-body squarebox square_boxs">
                    <div class="col-md-12 pull-left nopadmar no_padding">
                        <div class="row no_padding">
                            ...
                            <div class="col-md-4 no_padding col-xs-4" style="text-align:right;">
                                <i class="livicon pull-right" data-name="pen" data-l="true" data-c="#fff" data-hc="#fff"
                                    data-s="80" id="livicon-13" style="width: 80px; height: 80px;"></i>
                            </div>
                        ...
                        <div class="row no_padding">
                            ...
                            <div class="col-md-4 no_padding col-xs-4" style="text-align:right;">
                                <i class="livicon pull-right" data-name="eye-open" data-l="true" data-c="#fff"
                                    data-hc="#fff" data-s="80" id="livicon-14" style="width: 80px; height: 80px;"></i>
                            </div>
                        ...
                        <div class="row no_padding">
                            ...
                            <div class="col-md-4 no_padding col-xs-4" style="text-align:right;">
                                <i class="livicon pull-right" data-name="briefcase" data-l="true" data-c="#fff"
                                    data-hc="#fff" data-s="80" id="livicon-15" style="width: 80px; height: 80px;"></i>
                            </div>
    ...
    <div class="container-fluid footer-text">
        ...
        <div class="col-sm-4">
            ...
            <div>
                ...
                <ul class="list-inline">
                    <li>
                        <a href="https://www.facebook.com/Whitebox-981156722045221/?modal=admin_todo_tour"> <i
                                class="livicon" data-name="facebook" data-size="18" data-loop="true" data-c="#fff"
                                ata-hc="#ababab" id="livicon-14" style="width: 18px; height: 18px;">
                            </i> </a>
                    </li>
                    <li>
                        <a href="https://twitter.com/Whitebox_Ke"> <i class="livicon" data-name="twitter" data-size="18"
                                data-loop="true" data-c="#fff" data-hc="#ababab" id="livicon-15"
                                style="width: 18px; height: 18px;"></i> </a>
                    </li>

                    <li>
                        <a href="https://plus.google.com/u/1/"> <i class="livicon" data-name="google-plus"
                                data-size="18" data-loop="true" data-c="#fff" data-hc="#ababab" id="livicon-16"
                                style="width: 18px; height: 18px;"></i> </a>
                    </li>
                    <li>
                        <a href="https://www.instagram.com/whitebox_ke/"> <i class="livicon" data-name="instagram"
                                data-size="18" data-loop="true" data-c="#fff" data-hc="#ababab" id="livicon-17"
                                style="width: 18px; height: 18px;"></i> </a>
                    </li>
        ...
        <div class="col-sm-4">
            ...
            <li><i class="livicon icon4 icon3" data-name="cellphone" data-size="18" data-loop="true" data-c="#ccc"
                    data-hc="#ccc" id="livicon-18" style="width: 18px; height: 18px;"></i>Phone:<br>
                +254 20 2211960<br>
                +254 20 2211961
            </li>

            <li><i class="livicon icon3" data-name="mail-alt" data-size="20" data-loop="true" data-c="#ccc"
                    data-hc="#ccc" id="livicon-19" style="width: 20px; height: 20px;"></i> Email:<span
        ...
        <div class="col-sm-4">
            <a class="twitter-timeline" data-height="310"
                href="https://twitter.com/Whitebox_Ke?ref_src=twsrc%5Etfw">Tweets by Whitebox_Ke</a>
...
<i title="Raphaël Colour Picker" style="display: none; color: purple;"></i><iframe scrolling="no"
    allowtransparency="true" src="Huduma_WhiteBox/css/widget_iframe.html" title="Twitter settings iframe"
    style="display: none;" frameborder="0"></iframe><iframe id="rufous-sandbox" scrolling="no" allowtransparency="true"
    allowfullscreen="true"
    style="position: absolute; visibility: hidden; display: none; width: 0px; height: 0px; padding: 0px; border: medium none;"
