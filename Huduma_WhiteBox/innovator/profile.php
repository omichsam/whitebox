...
<div class="col-md-12 no_padding col-xs-12">
    ...
    <form action="" id="update_myprof_form" name="update_myprof_form" method="POST" accept-charset="UTF-8"
        class="form-horizontal col-md-12 no_padding" enctype="multipart/form-data">
        <div class="form-group col-md-12 infor_wrappers no_padding">
            ...
            <div class="col-md-12" style="border-top:2px dashed #ccc">
                <h3 class="text-primary" style="text-align:center;margin-top: -5px;" id="title">Personal Information
                </h3>
            </div>
                ...
                <div class="no_padding col-md-12">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group">
                            ...
                            <input type="text" required placeholder=" " name="first_name" id="uf-name"
                ...
                <div class="no_padding col-md-12">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group">
                            ...
                            <input type="text" required placeholder=" " name="last_name" id="ul-name"
                ...
                <div class="no_padding col-md-12">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group">
                            ...
                            <input type="text" placeholder=" " name="pdtp_number" id="pdtp_no"
                                class="form-control" value="<?php echo $pdtp_number ?>">
                        </div>
                        <span class="help-block"></span>
                    </div>
                </div>
                        ...
                        <div class="radio">
                            <label>
                                <div class="iradio_minimal-blue" style="position: relative;">
                                    <input type="radio" name="gender" <?php echo $female ?> value="female">
                                </div>
                                Female
                            </label>
                        </div>
                ...
                <div class="no_padding col-md-12">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group">
                            ...
                            <input required="" id="datepicker" class="form-control" data-date-format="YYYY-MM-DD"
                                name="dob" type="date" value="<?php echo $dob ?>">
                        </div>
            ...
            <div class="col-md-12 no_padding" style="border-top:2px dashed #ccc;margin-top: -10px;">
                <h3 class="text-primary" style="text-align:center;margin-top: -10px;" id="title">Education Background
                </h3>
                ...
                <div class="col-md-12 no_padding">
                    ...
                    <div class="col-lg-9 no_padding">
                        <div class="input-group">
                            ...
                            <select ="" class="form-control select2" id="education_high" name="education_high">
                ...
                <div class="col-md-12 no_padding high_school">
                    ...
                    <div class="col-lg-9 no_padding">
                        <div class="input-group">
                            ...
                            <input type="text" required="" value="<?php echo $SecondarySchool ?>" placeholder=" "
                                name="SecondarySchool" id="SecondarySchool" class="form-control">
                ...
                <div class="col-md-12 no_padding">
                    ...
                    <div class="col-lg-9 no_padding">
                        <div class="input-group">
                            ...
                            <input type="text" required="" value="<?php echo $PrimarySchool ?>" placeholder=" "
                                name="PrimarySchool" id="PrimarySchool" class="form-control">
                ...
                <div class="col-md-12 no_padding colleges">
                    ...
                    <div class="col-lg-9 no_padding">
                        <div class="input-group">
                            ...
                            <input type="text" required placeholder=" " value="<?php echo $College ?>" name="College"
                                id="College" class="form-control" \>
                ...
                <div class="col-md-12 no_padding colleges">
                    ...
                    <div class="col-lg-9 no_padding">
                        <div class="input-group">
                            ...
                            <input type="text" required placeholder=" " id="Certifications"
                                value="<?php echo $Certifications ?>" name="Certifications" class="form-control">
            ...
            <div class="form-group col-md-4 infor_wrappers no_padding">
                <div class="col-md-12 no_padding">
                    ...
                    <div class="col-lg-9 no_padding">
                        <div class="input-group">
                            ...
                            <input type="text" required placeholder=" " id="email" name="email" class="form-control"
                ...
                <div class="col-md-12 no_padding">
                    <label class="control-label  col-lg-3">Select Country:
                        <span class="require">*</span> </label>
                    <div class="col-lg-9 no_padding">
                        <select required="" class="form-control select2 select2-hidden-accessible" id="countries"
                            name="country" tabindex="-1" aria-hidden="true">
...
<script type="text/javascript">
    $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if ($.trim(dresponce) == "success") {
                            ...
                            $("#dashpdrt").html("Welcome " + fname);
                            $('html, body').animate({ scrollTop: '0px' }, 300);
                            $("#user_email").val(btoa(email));
        ...
        $("#pic").change(function () {
            ...
            //This hides / unhides various form input elements in the education section.
