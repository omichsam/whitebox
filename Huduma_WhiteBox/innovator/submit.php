...
// Get user email – session username is now plain text (no base64_decode)
...
$innocount = mysqli_query($con,"SELECT * FROM innovations_table WHERE user_id='$user_id' and Status='submission' or user_id='$user_id' and Status='waiting' or
user_id='$user_id' and Status='evaluation' or user_id='$user_id' and Status='second_evaluation'or user_id='$user_id' and Status='approved' or user_id='$user_id' and Status='first_disapproved' or user_id='$user_id' and Status='disapproved'or user_id='$user_id' and Status='implementation'");
$mastercount = mysqli_num_rows($innocount);
/*if($mastercount>=2){
  ...
  if($companycounts>0){
$companyshows="";
$companyadds="not_shown";
  }else{
$companyshows="not_shown";
$companyadds="";
  }
...
$innovation_levelshow="not_shown";
 ...
 $company_name="";
 $get_company=mysqli_query($con,"SELECT company_name FROM company WHERE id='$company_id'") or die(mysqli_error($con));
$get_com=mysqli_fetch_assoc($get_company);

 $company_name=$get_com['company_name'];
if($company_name){
...
//echo "this is the id".$company_name;
...
color: #6a8d96;
                        ...
                        <form id="commentForm" action="" method="POST" enctype="multipart/form-data" class="form-horizontal bv-form" novalidate="novalidate">
                            ...
                            <div id="rootwizard">
                                <ul class="nav nav-pills">
                                    ...
                                    <li>
                                        <span class=" btn-danger btn" style="float: right;" id="cancel_submission">Cancel submission</span>
                                    </li>
                                </ul>
  ...
  <div class="col-sm-4 tips">
    ...
    <ol>
     <li>-&gt;Terms and Conditions act as a legally binding contract between you and us. </li> <li>-&gt; Kindly note,if your innovation is not protected we will not be liable for copyright infringement subject to your submission to WhiteBox.</li></ol>
   </div>
                                    </div>
...
<input <?php echo $individual_check?> class="innovator_type" name="innovator_type" type="radio" value="Individual" id="innovator_type">Individual</label>
  <label class="radio-inline"><input name="innovator_type" <?php echo $company_check?> class="innovator_type" type="radio" value="Company" id="">Company</label>
 </div>
 <div  class="displayCompany form-group col-sm-12  <?php echo $company_class?>">

  <div id="displayCompany" class="<?php echo $company_class?>">
<label for="company_id">Company:</label><span style="color: red;">*</span><span class="<?php echo $companyshows?>">(if the company your are applying for doesn't appear in the list, proceed to add it)</span>
<div class="col-xs-12 col-sm-12 <?php echo $companyshows?>">
<select class="form-control required <?php echo $companyshows?>" required="" id="company_id" name="company_id" data-bv-field="company_id"><option class="<?php echo $companyshown?>"><?php echo $mycompany_id?></option>
  <option></option><?php 
  $sql="SELECT * FROM company where user_id='$user_id'";
  $query_run=mysqli_query($con,$sql) or die($query_run."<br/><br/>".mysqli_error($con));
  while($row=mysqli_fetch_array($query_run)){
    ...
    <?php
     ...
     ?>
      ...
      <br>
      <p>&nbsp;</p>
     <span class="<?php echo $companyshows?>"> OR:</span>
      <a id="add_newcompany" class="btn btn-primary" style="color: #fff;">
        <i class="livicon" data-name="plus" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true" id="livicon-12" style="width: 18px; height: 18px;">
          
        </i>
        Click here to add a New Company &gt;&gt;
      </a>
    </div>
    <div id="company_datap" class=" <?php echo $companyadds?>">
   <!-- progressbar -->
<div class="col-md-12">&nbsp;</div>
<ul class="nav nav-pills companyfform">
  <li class="active bv-tab-error"><a href="#tab1" data-toggle="tab" aria-expanded="true">Please Provide your Company Details</a></li>
</ul>
<div class="tab-content companyfform" id="">
  <!-- TAB 1 START  -->
  <div class="col-md-12">
      ...
      <div class="form-group has-error">
        ...
        *</label>
        <div class="col-sm-9">
          ...
          <small style="" class="help-block" data-bv-validator="notEmpty" data-bv-for="company_registration_no" data-bv-result="INVALID">This field is required</small></div></div>
<div class="form-group has-error">
...
<small style="" class="help-block" data-bv-validator="notEmpty" data-bv-for="kra_pin" data-bv-result="INVALID">This field is required</small></div>
 ...
 <div class="form-group has-error">
<label for="company_type" class="col-sm-3 control-label">What is your company type? Please select: *</label>
<div class="col-sm-9">
...
<span class="help-block"></span><!-- Attachment Field -->
                                        <!--
                                            <div class="form-group col-sm-12">
...
?>
                                           ...
                                           <div class="form-group col-sm-12 <?php echo $sho_ppt?> col-lg-12" id="attachment_cover">
                                                <label for="Solution">A an intellectual property protection document.<span style="color: red"><strong>(pdf files Only, convert any other file format to pdf format before attatching it.Maximum size, 5MBs)</strong></span></label>
                                            <input type="file" name="doc" id="file" class="property_protection"> 
                                              
                                                <div class="col-md-12" id="errorfiles"></div>
                                            <a class="<?php echo $sho_ppt?>"><?php echo $older_ppt?></a>
                                            </div>
                                             <div class="form-group col-sm-12 col-lg-12">
                ...
                <div class="col-md-12" id="perrorfiles"></div>
...
<!--
                                    ...
                                    <div class="tab-pane col-md-12 no_padding" id="tab6">
                                        ...
                                        <div id="dock_display" class="not_shown col-md-12 no_padding">
                               
                                        </div>
                                        <div class="col-sm-12">
                                            <!-- Terms And Conditions 2 Field -->
                                            <div class="form-group col-sm-6">
                                                <label for="terms_and_conditions_2">Please confirm that you agree to the terms and conditions again.</label></br>
                                                <label class="checkbox-inline">
...
var mastercount='<?php echo $mastercount?>';
if(mastercount>=2){
var txt;
  var r = confirm("Sorry you can not submit more than two innovations, kindly wait for complete evaluation for the one(s) you submited before submting other innovations, click OK or CANCEL end this process?");
  if (r == true) {
...
$("#submision_error").html("...redirecting to innovations page.."+loader).css("color","#000");  
...
var my_id=$("#user_email").val();
          $.post('Huduma_WhiteBox/innovator/innovation/show_table.php',{my_id:my_id},function(data){
         $("#summary").html(data);
       });
   $("#file").change(function(){
        ...
        var mb=mbs.toFixed(2);
        //alert(mb)
       $("#errorfiles").html("File size:"+mb+"Megabytes").css("color","black");
        }else{

         $("#errorfiles").html("File size should not be greater than 10mbs").css("color","red");   
        }
        }else{
         $(this).val("");
         $("#errorfiles").html("Only pdf files allowed").css("color","red");
        }
   })
   ...
   $("#attach_file").change(function(){
        ...
        var mb=mbs.toFixed(2);
        //alert(mb)
       $("#perrorfiles").html("File size:"+mb+"Megabytes").css("color","black");
        }else{

         $("#perrorfiles").html("File size should not be greater than 10mbs").css("color","red");   
        }
        }else{
         $(this).val("");
         $("#perrorfiles").html("Only pdf files allowed").css("color","red");
        }
   })
...
var innovationName=$.trim($("#innovationName").val());
...
$('html, body').animate({scrollTop: '0px'}, 300);
    ...
    $("#submision_error").html("All Fields required").css("color","red");
     ...
     var ProblemSolution=$.trim($("#ProblemSolution").val());
     var Problemidentified=$.trim($("#Problemidentified").val());
     var impact=$.trim($("#impact").val());
     var Explain=$.trim($("#Explain").val());
     var InnovationLevel=$.trim($("#InnovationLevel").val());
...
$(".tab-pane").removeClass("active show").hide();
          ...
          $("#currentpage").html(new_page);
            ...
            var research=$.trim($("#research").val());
           var research_letter=$.trim($("#research_letter").val());
           var targeted=$.trim($("#targeted").val());
           var busines_model=$.trim($("#busines_model").val());
...
var patn="";
var partners_involved=$.trim($("#partners_involved").val());
...
$("#submision_error").html("Required")
 ...
 patn="";
    ...
    if(fund || commn || implement || patner || acquisition_d){
      ...
      var user_defined="";
         if($("#Others").prop("checked")){
               var  user_defined=$.trim($("#user_defined").val());
               if(user_defined){
                 patcheck="ready";
    //alert()
                $("#user_defined").css("border","1px solid #ccc")
...
var leafattach="";
   var attach_document=$("#attach_file").val();
             ...
             var attachment_link=$.trim($("#link").val());
...
var my_id=$("#user_email").val();
 $.post("Huduma_WhiteBox/innovator/innovation/confirmsubmission.php",{my_id:my_id},function(data){})
...
$("#cancel_submission").click(function(){
       var txt;
  var r = confirm("Do you wish to do away with the innovation submission?, press Ok to proceed or cancel to stop?");
  if (r == true) {
