...
<section class="content-header dashboard_holder">
    ...
    <h3 id="dashpdrt"><?php echo $error_message ?>
        ...
        <a class="btn-sm desktop_hidden btn-danger" id="log_touter"
            style="color: #fff;cursor: pointer;float: right;">Logout</a>
        <a style="float: right;">&nbsp;&nbsp;&nbsp;</a>

        
        <a style="float: right;">&nbsp;&nbsp;&nbsp;</a>
        <a class="notificationbtn btn menu_dtz desktop_hidden" style="float: right;" id="notifications"><i
                class="fa fa-bell not_shown bell_hides"></i><i class="notyholderp"></i></a>
