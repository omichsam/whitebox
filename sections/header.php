...
<header class="gradient-r text-primary py-4 shadow-lg sticky top-0 z-50">
    <div class="container mx-auto flex justify-between items-center px-4 text-dark">
        <!-- Left Logo -->
        <!-- <div class="hidden md:block md:scale-90 lg:scale-100"> -->
        <div class="flex items-center">
            <div
                class="w-24 md:w-20 h-20 md:h-12 bg-whitea rounded-lg flex items-center justify-center mr-3 overflow-hidden">
                <img src="sources/images/logo/Coat_of_arms_of_Kenya.svg.png" alt="Government Logo"
                    class="w-full h-full object-contain bg-white/20 p-1">

            </div>
            <div
                class="w-24 md:w-20 h-20 md:h-12 bg-whitea rounded-lg flex items-center justify-center mr-3 overflow-hidden">
                <img src="sources/images/logo/icta_logo-nobg.png" alt="Government Logo"
                    class="w-full h-full object-contain bg-white/20 p-1">
        ...
        <nav class="hidden lg:block">
            <ul class="flex space-x-4 xl:space-x-6 font-bold">
                ...
                <li><a href="about.php"
                        class="text-primary hover:text-accent transition duration-300 font-bold text-sm xl:text-base">WHO
                        WE
                        ARE</a></li>
  ...
  Open Confirmation
        ...
        <div class="hidden md:flex items-center">
            <div class="w-32 md:w-20 h-24 md:h-14 rounded-xl flex items-center justify-center ml-3 overflow-hidden ">

                <img src="sources/images/logo/Whitebox.png" alt="Whitebox Logo" class="w-full h-full object-contain"
                    height="auto">
            </div>
        </div>
    ...
    <div id="mobile-menu"
        ...
        <div class="flex justify-between items-center p-4 border-b border-gray-700">
            <div class="flex items-center">
                <div
                    class="w-auto h-12 gradient-light rounded-lg flex items-center justify-center mr-3 overflow-hidden">
