    ...
    <div class="absolute inset-0 flex items-center justify-center p-4">
        ...
        <div
            ...
            <div class="p-6 relative overflow-hidden" style="min-height: 450px;">
                <!-- LOGIN FORM -->
                <form id="loginForm" class="space-y-5" method="POST" action="login/login.php">
                ...
                <!-- SIGN UP FORM -->
                <form id="signupForm" class="space-y-5 hidden" method="POST" action="login/validate.php">
                ...
                <form id="forgotForm" class="space-y-5 hidden" method="POST" action="login/recover.php">
                ...
                <form id="resetPasswordForm" class="space-y-5 hidden" method="POST" action="login/reset.php">
                    <div class="text-center">
                        <div
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="new_passworn"
                                class="w-full border border-gray-200 rounded-xl py-3 pl-10 pr-4 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition"
...
<script>
    ...
    function showError(formElement, message) {
        ...
        const errorDiv = $(`<div class="error-message text-red-500 text-sm mt-2 text-center p-2 bg-red-50 rounded-lg"></div>`);
    ...
    function setupFormHandlers() {
        ...
        // Forgot password form
        $('#forgotForm').on('submit', handleForgotPassword);

        // Reset password form
        $('#resetPasswordForm').on('submit', handleResetPassword);

        // Investor form
        $('#investors').on('submit', handleInvestorForm);
    }
    ...
    function setupEmailValidation() {
        $(document).on('blur', "input[type='email']", function () {
            ...
            if (!validateEmail(emailVal)) {
                $(this).val("");
                $(this).attr("placeholder", "Wrong email format!");
    ...
    // Password Strength Meter AngularJS Component
        ...
        angular.module("myapp", [])
            .controller("PasswordController", function ($scope) {
                ...
                $scope.analyze = function (value) {
                    if (!value) {
                        $scope.passwordStrength["width"] = "0%";
                        $scope.passwordStrength["background-color"] = "transparent";
                        return;
                    }
